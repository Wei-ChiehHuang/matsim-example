...
public class RunReplanningTripCar {
    ...
    public static void main(String[] args) {
        ...
        config.controler().setOutputDirectory("OutputMunich_replanningSkimCar_SC10");
        ...
        config.plans().setInputFile("skim/replanningPlansCar_SC10.xml");
