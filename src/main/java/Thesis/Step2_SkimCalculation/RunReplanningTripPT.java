...
public class RunReplanningTripPT {
    ...
    public static void main(String[] args) {
        ...
        config.controler().setOutputDirectory("OutputMunich_replanningSkimPt_SC10");
        ...
        config.plans().setInputFile("skim/replanningPlansPt_SC10.xml");
        config.transit().setUseTransit(true);
        config.transit().setTransitScheduleFile("input/schedule2018_replanningSkimPt.xml");
